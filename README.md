...
<!-- - **@Meta**: Participated in the [Meta Hacker Cup 2024](<img src="./images/MHC.png" alt="MHC" />), where I worked on complex coding problems. -->
- **@Meta**: Participated in the [![MHC](./images/MHC.png)](https://example.com)
